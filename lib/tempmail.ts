...
export async function callUpstream(url: string, params: any, sid: string, token: string) {
...
export async function callUpstreamPost(url: string, body: any, sid: string, token: string) {
