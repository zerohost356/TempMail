...
const ENDPOINTS: Endpoint[] = [
  ...
  },
  {
    ...
    testUrl: "/api/custom-email?username=testuser&domain=dotool8.top",
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Interactive API documentation for the TempMail service" />
      </Head>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="bg-[#161b22] border border-[#30363d] rounded-2xl p-5 mb-6 flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex-1">
            ...
            <code className="text-sm text-violet-300 font-mono">/api</code>
          </div>
